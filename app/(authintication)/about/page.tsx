...
const page = () => {
  ...
  return (
    <div >
      ...
      <div className='bg-[#E10102] w-full h-[300px] pt-4 md:pt-0  mx-auto px-10 md:px-20 '>
        <div className='flex justify-between flex-col md:flex-row  '>
          ...
          <div className="text-white text-4xl flex pt-[5%] justify-start gap-4">
            <Image
              ...
              className='h-[130px] md:h-[180px] w-[130px] md:w-[180px] cursor-pointer mb-[20px] rounded-full'
            />

            <Image
              src={image2}
              alt="Picture of the author"
              className='h-[130px] md:h-[180px] w-[130px] md:w-[180px]  cursor-pointer mt-[25px] rounded-full'
            />
          </div>

        </div>
      </div>
      <div className='text-md font-light text-slate-700 px-4 md:px-20 pt-20'>
